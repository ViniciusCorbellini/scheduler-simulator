...
public class SimulationResult {
    ...
    public SimulationResult(float utilization, Map<TCB, Integer> turnaround_times, float turnaround_time_avg, Map<TCB, Integer> waiting_times, float waiting_time_avg, Task highest_wt, Task lowest_wt, List<TCB> starvation, List<TCB> missed_deadline, Map<Integer, Float> deadline_miss_ratio) {
